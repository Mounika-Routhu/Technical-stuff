...
| **Structure** | **Best For**                       | **Keys/Index Type**     | **Order Preserved** | **Duplicates?** | **Quick Notes**                                                      |
| ------------- | ---------------------------------- | ----------------------- | ------------------- | --------------- | -------------------------------------------------------------------- |
| **Array**     | Ordered list of values             | Number index (0, 1...)  | ✅ Yes               | ✅ Yes (values)  | Use when order & duplicates matter                                   |
| **Object**    | Key-value pairs (non-complex keys) | Strings & Symbols only  | ⚠️ Mostly Yes     | ❌ No (keys)     | Use for simple key-value data; keys must be unique strings/symbols   |
