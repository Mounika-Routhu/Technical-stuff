...
| forEach  | Runs a function on each element (no return) | undefined                       | ```js [1,2,3,4].forEach(n => console.log(n)); // logs 1 2 3 4 ``` | Does not return a new array; good for side effects only, not for transformation. |
